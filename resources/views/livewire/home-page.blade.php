<div>
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">UltraShop</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Explore a wide variety of fashion products
                        including clothing, accessories, footwear, and more.</p>
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Explore our curated selection of popular brands that offer quality, reliability, and style. Whether
                    you're looking for essentials or the latest trends, find the perfect brand to match your needs and
                    preferences.
                </p>
            </div>
        </div>
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Explore our carefully selected categories designed to meet your lifestyle needs. From stylish footwear to elegant formal wear, casual outfits, and essential accessories, we have everything you need to elevate your wardrobe. Dive into each category and discover your next favorite piece.
                </p>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Contact <span class="text-blue-500"> Us
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-8 md:p-12">
                <form action="https://api.web3forms.com/submit" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="name" id="name" required autocomplete="off">
                        </div>
                        <div>
                            <label class="block text-gray-700 mb-2" for="email">Email</label>
                            <input
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                type="email" name="email" id="email" required autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            name="message" id="message" rows="5" required autocomplete="off"></textarea>
                    </div>

                    <div class="mt-6 text-center">
                        <button type="submit"
                            class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition duration-300">
                            Send Message
                        </button>
                    </div>
                </form>
